...
<section class="py-8">
    <div class="max-w-2xl mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-light-text">Edit Kategori</h1>
        ...
        <div class="bg-card-bg border border-border-color rounded-lg p-6">
            <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" value="{{ $kategori->name }}" class="w-full bg-dark-bg border border-border-color rounded py-3 px-4 text-light-text focus:outline-none focus:border-accent-green" required>
                </div>
